...
import aaditya.dev.cafeapp.domain.BeerOrder.BeerOrderBuilder;
import aaditya.dev.cafeapp.domain.BeerOrderLine;
import aaditya.dev.cafeapp.web.model.BeerOrderDto;
import aaditya.dev.cafeapp.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import aaditya.dev.cafeapp.web.model.BeerOrderLineDto;
import aaditya.dev.cafeapp.web.model.OrderStatusEnum;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum(aaditya.dev.cafeapp.domain.OrderStatusEnum orderStatusEnum) {
    ...
    protected aaditya.dev.cafeapp.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        aaditya.dev.cafeapp.domain.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = aaditya.dev.cafeapp.domain.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = aaditya.dev.cafeapp.domain.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = aaditya.dev.cafeapp.domain.OrderStatusEnum.PICKED_UP;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + orderStatusEnum );
        }
